...
where match.HTeam=team1.Teamname
select team1.TeamCode)
void main()
{
...
var matchlist = (from match in Matches,team1 in Teams where match.HTeam equals team1.TeamName
				and team2 in Teams equals match.GTeam equals team2.TeamName) 
				select match,team1.TeamCode)
